        ...
        <section className="min-h-screen w-full flex items-center justify-center bg-primary/20 relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute top-5 right-5 md:top-10 md:right-10 lg:right-20 w-12 h-12 md:w-24 md:h-24 bg-yellow-400 border-2 md:border-4 border-black rounded-full flex items-center justify-center shadow-cartoon md:shadow-cartoon-lg z-0"
                >
                    {[...Array(8)].map((_, i) => (
                        <div
                            key={i}
                ...
                <motion.div
                    ...
                    className="absolute top-20 left-2 md:top-32 md:left-20 scale-50 md:scale-100 origin-top-left"
                >
            ...
            <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div className="text-center md:text-left md:w-1/2">
                    <motion.div
                        ...
                        className="inline-block mb-4 md:mb-6 px-4 py-1 md:px-6 md:py-2 bg-white text-black border-2 md:border-4 border-black shadow-cartoon rotate-[-2deg]"
                    >
                        <span className="text-sm md:text-xl font-bold">👋 Hello, I'm Sarthak!</span>
                    </motion.div>
                    ...
                    <motion.h1
                        ...
                        className="text-3xl md:text-7xl lg:text-8xl font-black mb-4 md:mb-6 tracking-tight"
                    >
                        CREATIVE
                        <br />
                    ...
                    <motion.p
                        ...
                        className="text-base md:text-2xl font-bold mb-6 md:mb-10 max-w-2xl mx-auto md:mx-0"
                    >
                    ...
                    >
                        <Link
                            href="#projects"
                            className="px-5 py-2.5 md:px-8 md:py-4 bg-primary text-black font-black text-sm md:text-lg border-2 md:border-4 border-black shadow-cartoon hover:shadow-cartoon-hover hover:translate-x-[2px] hover:translate-y-[2px] transition-all rounded-xl"
                        >
                            SEE MY WORK
                        </Link>
                        <Link
                            href="#contact"
                            className="px-5 py-2.5 md:px-8 md:py-4 bg-white text-black font-black text-sm md:text-lg border-2 md:border-4 border-black shadow-cartoon hover:shadow-cartoon-hover hover:translate-x-[2px] hover:translate-y-[2px] transition-all rounded-xl"
                        >
                            CONTACT ME
                        </Link>
                    </motion.div>
