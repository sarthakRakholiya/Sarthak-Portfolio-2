        ...
        <section id="contact" className="py-20 bg-background relative overflow-hidden">
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <h3 className="text-2xl md:text-4xl font-black mb-8 uppercase tracking-widest">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-20">
                        {[
                            ...
                            >
                                ...
                                {/* Button Top */}
                                <div className={`relative h-full p-6 ${item.color} border-4 border-black rounded-xl flex flex-col items-center justify-center gap-4 transition-transform`}>
                                    <item.Icon className="w-10 h-10 text-white" />
                                    <div className="text-center">
                                        <h3 className="text-xl font-black text-white uppercase tracking-wider">{item.title}</h3>
                                        <p className="font-bold text-white/80 text-sm uppercase">{item.text}</p>
                                    </div>
                                </div>
                            </motion.a>
                        ))}
